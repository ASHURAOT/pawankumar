...
const email = "mailto:ps38819@gmail.com";
...
export function Portfolio() {
  ...
  return <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
    ...
    <main id="main-content">
      ...
      <section id="certifications" className="section certification reveal"><div className="section-inner"><SectionHeading eyebrow="05 / CERTIFICATION" title="Validated Kubernetes administration."/><article className="cert-card"><div className="cert-seal"><Award/><span>CKA</span></div><div className="cert-copy"><p className="eyebrow">LINUX FOUNDATION</p><h3>Certified Kubernetes Administrator</h3><p>Completed June 24, 2026</p><span className="credential-id">Certificate ID: LF-b3rwy9nogw</span></div><ButtonLink href={certificateAsset.url} target="_blank" rel="noopener noreferrer" variant="secondary">View certificate <ExternalLink/></ButtonLink></article></div></section>
