...
const buttonVariants = cva(
  ...
  { variants: {
    ...
    size: { default: "h-10 px-4 py-2", sm: "h-9 px-3", lg: "h-11 px-5", icon: "size-10 p-0" },
...
function ButtonLink({ className, variant = "default", ...props }: React.AnchorHTMLAttributes<HTMLAnchorElement> & VariantProps<typeof buttonVariants>) {
  return <a className={cn(buttonVariants({ variant, size: "lg", className }))} {...props} />;
}
